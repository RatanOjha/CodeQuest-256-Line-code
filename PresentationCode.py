...
locations = {
    ...
    "Spacee": "You are the captain of the starship 'Odyssey' on a mission to explore the cosmos.",
...
def fuel_steps():
    ...
    fuel_decrease = random.randint(1, 3) * 5  # Selects a number between 10 and 20 in increments of 5
